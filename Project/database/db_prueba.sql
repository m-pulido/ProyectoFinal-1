...
CREATE TABLE IF NOT EXISTS `beneficiarios` (
  ...
  `ID_LLAMADA` int(2) DEFAULT,
  `ID_ENTREGA_BENEFICIARIO` int(2) DEFAULT,
  ...
  CONSTRAINT `beneficiario_ibfk_4` FOREIGN KEY (`ID_LLAMADA`) REFERENCES `registro_llamada` (`ID_LLAMADA`),
